...
describe( 'child_process', function() {
  ...
  it('should be able to async spawn', function(done) {
     var content = '';
  ...
  it('should be able to kill a spawned process', function(done) {
  ...
  it( 'should be able to exec', function(done) {
  ...
  it( 'should be able to execFile', function(done) {
    var content = '';
  ...
  it( 'should be able to fork', function(done) {
  ...
  it( 'should be able to send sockets to a child', function(done) {
      var connection;
