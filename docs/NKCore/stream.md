...
{NK} NodeKit.  For example a [request to an HTTP
...
Almost all {NK} NodeKit programs, no matter how simple, use Streams in some
way.  Here is an example of using Streams in a {NK} NodeKit program:
