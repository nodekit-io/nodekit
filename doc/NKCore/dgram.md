...
# UDP / Datagram Sockets
    ...
    Untouched Node.js API with native asnchronous binding to core OS (e.g., using GCD on OSX and iOS).

<!-- name=dgram -->

Datagram sockets are available through `require('dgram')`

Important note: the behavior of `dgram.Socket#bind()` is always asynchronous 

If you have an old V0.10 Node.js application that you want to use with {NK} NodeKit or Node.js V0.12 or later, you have to change it to this:
