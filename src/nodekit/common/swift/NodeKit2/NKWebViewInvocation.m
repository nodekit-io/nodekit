...
#import "NKWebViewInvocation.h"

@interface NSNumber (NKWebViewInvocation)
- (NSNumber *)initWithInvocation:(NSInvocation *)invocation;
- (void)getValue:(void *)buffer objCType:(const char *)type;
@end

@interface NSInvocation (NKWebViewInvocation)
...
@implementation NSValue (NKWebViewInvocation)
...
@implementation NKWebViewInvocation

+ (id)construct:(Class)aClass initializer:(SEL)selector arguments:(NSArray *)args {
    return [NKWebViewInvocation constructOnThread:nil class:aClass initializer:selector arguments:args];
}
...
+ (NSValue *)call:(id)target selector:(SEL)selector arguments:(NSArray *)args {
    return [NKWebViewInvocation callOnThread:nil target:target selector:selector arguments:args];
}
...
+ (void)asyncCall:(id)target selector:(SEL)selector arguments:(NSArray *)args {
    return [NKWebViewInvocation asyncCallOnThread:NSThread.currentThread target:target selector:selector arguments:args];
}
...
@implementation NSNumber (NKWebViewInvocation)
...
@implementation NSInvocation (NKWebViewInvocation)
+ (NSInvocation *)invocationWithTarget:(id)target selector:(SEL)selector arguments:(NSArray *)args {
